...
### Combined Stats {.tabset .tabset-fade .tabset-pills}
...
contested_dat30 %>% 
  ...
  theme(legend.position = "bottom", plot.title = element_text(size = 28, face = "bold", hjust = 1.25), text=element_text(family="mono", face = "bold"), plot.caption = element_text()) +
...
# saveRDS(prov, "data/prov.rds")
prov <- readRDS("data/prov.rds")
```
