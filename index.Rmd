...
For Google platforms, data accessed via the [Google Transparency Report](https://transparencyreport.google.com/political-ads/region/NL) provides exact spending on how much money was spent by parties in last 30 and 7 days.
...
#### Feb 13th to Mar 14th 2023 (Last 30 days)
...
#### Mar 8th to 14th 2023 (Last 7 days)
...
```{r,fig.width=12, fig.height=8,eval=F}
 interest_targeting30 %>% 
  ...
  ggthemes::theme_hc() +
  ggthemes::theme_hc() +
  labs(x = "Targeting criteria", y = "Budget spent on targeting method (in Euro)", title = "Top Targeted Audiences by BBB", subtitle = " ", 
       caption = "Source: Meta Ad Library and data compiled by Who Targets Me.\nData Viz: Fabio Votta (@favstats).") +
  theme(plot.title = element_text(size = 28, face = "bold", hjust = 0.5), text=element_text(family="mono", face = "bold"), plot.caption = element_text()) +
  theme(legend.position = "none")
```
