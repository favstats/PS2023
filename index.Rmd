...
For Google platforms, data accessed via the [Google Transparency Report](https://transparencyreport.google.com/political-ads/region/NL) provides exact spending on how much money was spent by parties in last 30 days. The table below shows spending in the timerange between **February 11th to March 13th 2023**.
...
all_zip  %>%
    ...
    ggthemes::theme_hc() +
    labs(x = "Ad Budget Spend on Postal Codes",
         y = "% of population receiving benefits") +
    theme(legend.position = "none") +
    labs(caption = "Data: Meta Ad Library; CBS. Data Viz: @favstats")
```
